...
- [x] Une propriété devra être partagé par les Type de vehicule et devra être definit à l'instantiation de ceux-ci. Cette propriété est Moteur et représente une     instance de cette classe.
